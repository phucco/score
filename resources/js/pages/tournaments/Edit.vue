<template>
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">Edit tournament: {{ tournament.name }}</div>
      <div class="card-body">
        ...
        <form v-on:submit.prevent="saveTournament">
...
const { errors, updateTournament, getTournament, tournament } = useTournaments()

const saveTournament = async () => {
  await updateTournament(props.id)
}
